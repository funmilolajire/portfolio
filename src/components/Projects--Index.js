...
export const ProjectsMainIndex = () => {
    ...
    return (
        <div className="relative ProjectsMainIndex">
            <h2 className="pb-4 text-5xl font-bold text-center mb-14">Projects</h2>
            <div className="relative grid grid-flow-row grid-cols-3 justify-items-center gap-x-14 gap-y-14 auto-rows-fr Projects auto-cols-min">
